...
def get_dexed_descriptors():
    ...
    descriptors |= {
        key: MemberDict(
            {
                "serialize": lambda x: (x["value"] - x["param"].min_value)
                / (x["param"].max_value - x["param"].min_value),
        ...
        "ALGORITHM": MemberDict(
            {
                ...
                "unserialize": lambda x: x["param"].current_value
                if x["interface"].algorithm is None
                else x["interface"].algorithm,
            }
        )
    }
    descriptors |= {
...
class DexedInterface(BaseInterface):
    ...
    def __init__(self, *args, **kwargs):
        super(DexedInterface, self).__init__(*args, **kwargs)
